    ...
    return (
      <div className="section skeleton">
        <div className="container pad10">
          <div className="e-breadcrumb col-md-12 d-flex">
            <div className="skeleton-box rectangle col-md-2 mr-1" />
            <div className="skeleton-box rectangle col-md-2 mr-1" />
          </div>

          <div className={`${window.innerWidth < 767 ? 'mt-5' : 'd-flex'} col-md-12 col-md-12 col-md-12 p-0`}>
          ...
          {/* ижил бараа */}
          <div className="col-md-12 col-md-12 col-md-12 p-0 d-flex mt-5">
          ...
          {/* танилцуулга */}
          <div className="col-md-12 col-md-12 col-md-12 p-0 mt-5">
