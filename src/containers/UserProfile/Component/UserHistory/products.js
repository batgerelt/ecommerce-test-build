...
class Component extends React.Component {
  ...
  render() {
    const { item, isSaved, lang } = this.props;
    const { loading } = this.state;
    return (
      <Row className="single flex-this flex-space" style={{ border: "1px solid white" }}>
          ...
          <ul className="list-unstyled flex-this">
            <li className="search-hover">
              <Button
                ...
                onClick={this.props.addHistory(item)}
              >
                <i
