...
class SwalModals extends React.Component {
  ...
  handleGetValue = () => { return console.log('SwalModals'); }
                  ...
                  <div className="content">
                    ...
                    <div className="user-detail">
                      ...
                      <p className="text flex-this">
                        ...
                        <span>
                          {chosenInfo.length !== 0
                            ? `${chosenDeliveryAddrName.mainLocation}, ${chosenDeliveryAddrName.subLocation}, ${chosenDeliveryAddrName.commiteLocation}, ${addrs}`
                            : ""}
                        </span>
                      </p>
                      <p className="text flex-this">
