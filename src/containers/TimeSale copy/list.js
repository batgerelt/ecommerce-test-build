...
import { Spin, Statistic, Switch, Select, BackTop, Tree, Icon, Row, Col } from "antd";
...
import { Loader, SearchFilterSet, PageBanner } from "../../components";
import { CARD_TYPES } from "../../utils/Consts";
import crossImage from "../../scss/assets/svg/error-black.svg";
import styles from "../DynamicMenu/style.less";
        ...
        <div>
          <div className="top-container elastic-container">
            <div className="section season">
              <div className="container pad10" style={{ backgroundColor: "#fff" }}>
...
export default windowSize(injectIntl(Page));
