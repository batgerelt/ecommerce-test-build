...
class Checkout extends React.Component {
  ...
  changeChosenDate = (item, changeDist) => {
  ...
  changeChosenAddress = (item, last) => {
    if (this.props.userinfo.main !== null) {
      this.setState({ chosenAddress: item }, () => this.getDeliveryPrice());
    } else {
      ...
      this.setState({ chosenAddress: item }, () => this.getDeliveryPrice(last));
    }
  }
