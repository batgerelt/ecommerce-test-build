...
class Model extends BaseModel {
  ...
  getEmartProduct = ({
    jumcd, startsWith, rowCount, orderCol,
  }) => asyncFn({ url: `/product/${jumcd}/${startsWith}/${rowCount}/${orderCol}`, method: 'GET', model: this.model.emartproduct });
  getDiscountProduct = ({
    jumcd, startsWith, rowCount, orderCol,
  }) => asyncFn({ url: `/product/${jumcd}/${startsWith}/${rowCount}/${orderCol}`, method: 'GET', model: this.model.discountproduct });
  getNewProduct = ({
    jumcd, startsWith, rowCount, orderCol,
